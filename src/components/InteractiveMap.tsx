    ...
    <div style={{position: 'absolute', top: 0, left: 0, width: '100vw', height: '100vh', inset: 0, zIndex: 0}}>
      ...
      {activeComment && popupPosition && (
        ...
        >
          ...
          <div className="popup-comment-card" style={{background: 'rgba(34, 38, 54, 0.38)', borderRadius: 12, boxShadow: '0 0 0 0', padding: '12px 14px', margin: '10px 0 8px 0', minHeight: 40, maxWidth: '100%', width: '100%', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
